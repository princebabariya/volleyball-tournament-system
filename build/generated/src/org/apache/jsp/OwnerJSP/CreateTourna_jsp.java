...
public final class CreateTourna_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/OwnerJSP/OwnerHome.jsp");
  }
 ...
 while(rs.next()){ 
  ...
  try {
               ...
               int i=statement.executeUpdate("insert into tournaments(name,noofteams,sdate,edate,username)values('"+name+"','"+noofteam+"','"+sdate+"','"+edate+"','"+username+"')");
      ...
      out.write("               ");
      if (true) {
        _jspx_page_context.forward("OwnerHome.jsp");
        return;
      }
      out.write("\n");
      out.write("\n");

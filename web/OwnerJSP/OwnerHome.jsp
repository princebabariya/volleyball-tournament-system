    ...
    <script type="text/javascript">
      ...
      function sidebar() {
        ...
        <ul>
          ...
          <li><span id="listeam">Your Teams</span></li>
      ...
      document.querySelector("#payment").addEventListener(
        ...
        function (event) {
         ...
         <input type="hidden" name="username" value=<%=user%> />
          ...
          <div class="inputBox">
            <label></label>
            <input type="submit" <span id="profile"> </span> />
                     <a class="navLink" name="profile" href="#" <button type="button" <span id="profile">Your Profile</span></a>>Click Me!</button>
                    <a class="navLink" name="profile" href="#">
          </div>
        </form>
